...
COMPLETE_HYB_RVOD='NAS_DIST02/cdn/loaded/hybrid_rvod_sig'

COMPLETE_OTT_RVOD='NAS_INGEST01/cdn/ott_rvod_sig'

COMPLETE_HYB_AD='NAS_DIST02/cdn/loaded/hybrid_ad'

COMPLETE_OTT_AD='NAS_DIST02/cdn/loaded/ott_ad'

#Deploy Failed

FAILED_HYB_RVOD='NAS_DIST02/cdn/error'

FAILED_OTT_RVOD='NAS_INGEST01/cdn/ott_rvod_error'

FAILED_HYB_AD='NAS_DIST02/cdn/loaded/hybrid_ad/error'

FAILED_OTT_AD='NAS_DIST02/cdn/loaded/ott_ad/error'
